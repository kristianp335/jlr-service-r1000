...
/**
 * Provides the local service interface for R1000. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see R1000LocalServiceUtil
...
public interface R1000LocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link R1000LocalServiceUtil} to access the r1000 local service. Add custom service methods to {@link com.liferay.kris.jlr.r1000.service.impl.R1000LocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public R1000 addR1000(R1000 r1000);
	...
	*/
	public R1000 createR1000(long r1000Id);
	...
	*/
	...
	public R1000 deleteR1000(R1000 r1000);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public R1000 deleteR1000(long r1000Id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public R1000 fetchR1000(long r1000Id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public R1000 fetchR1000ByUuidAndGroupId(java.lang.String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public R1000 getR1000(long r1000Id) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public R1000 getR1000ByUuidAndGroupId(java.lang.String uuid, long groupId)
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public R1000 updateR1000(R1000 r1000);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<R1000> getR1000s(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<R1000> getR1000sByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
